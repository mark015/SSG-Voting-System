                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form method="post" action="editprocess.php" enctype="multipart/form-data">
                                            <input type="hidden" class="form-control" name="track_id" value="<?php echo $t_id ;?>">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                    <input type="text" class="form-control has-feedback-left" name="track_name" value="<?php echo $track_name; ?>" required="" />
                                                    <span class="glyphicon glyphicon-education form-control-feedback left" aria-hidden="true"></span>
                                                </div>
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                    <textarea class="form-control" name="track_desc" value="<?php echo "$track_desc"; ?>"></textarea>
                                                </div>
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group" style="margin-left: 10px;">
                                                    <button type="submit" name="edit_track" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i> Update</button>
                                                    <a href="form_track.php" class="btn btn-warning" type="button"><i class='fa fa-reply'> Cancel</i></a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
