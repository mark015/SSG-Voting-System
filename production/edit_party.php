                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form method="post" action="editprocess.php">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <input type="hidden" class="form-control" name="party_id" value="<?php echo $id ;?>">
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                    <input type="text" class="form-control has-feedback-left" name="party" value="<?php echo $party; ?>" required="" />
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group" style="margin-left: 10px;">
                                                    <button type="submit" name="edit_party" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i> Update</button>
                                                    <a href="form_party.php" class="btn btn-warning" type="button"><i class='fa fa-reply'> Cancel</i></a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
