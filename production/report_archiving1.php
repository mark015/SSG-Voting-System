		...
		<div class="container body">
			<div class="main_container">
                ...
                <div class="right_col" role="main" style="background-image: url(images/<?php echo $set_data['bg_image'];?>); background-repeat: no-repeat; background-size: cover;">
                    <form action="report_archiving1.php" method="get" role="form">
                        <div class="row clearfix"> 
                            <div class="col-sm-11">
                                <div class="form-group">
                                    <div class="form-line"><label for="m">Input Year</label>
                                        <select name="year" class="form-control rayxd">
                                           <?php 
                                               $year=date('Y');
                                               while($year>1999){
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="header">
                                    <h2><strong><?php echo $yr. " "; ?></strong>Elected Candidates</h2>
                                </div>
                                <div class="body">
                                    <div class="table-responsive"> 
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $sql="SELECT * from tbl_archive where year LIKE '$yr%' group BY position order by archive_id";
                                                    $mysql_connection_object = mysqli_connect($servername,$username,$password,$dbname);
                                                    $qry=$mysql_connection_object->prepare($sql);
                                                    $qry->execute();
                                                    $qry->bind_result($id, $firstname , $lastname , $middlename , $position, $party, $level, $votes, $year1 );
                                                    while($qry->fetch()) {
                                                        echo "<tr>
                                                                <td>$position</td>
