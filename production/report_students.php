<?php
    ...
    function fetch_data_grade11() {  
        ...
        while($row = mysqli_fetch_array($result)) {   
            date_default_timezone_set("Asia/Manila");  
            $date=date("Y-m-d"); 
            $diff=date_diff(date_create($row["bdate"]),date_create($date));
            $age=$diff->format('%y');
            $x++;
            if($row["cellphone"] == 0){
                $row["cellphone"] = "";
    ...
    if(isset($_POST["generate_pdf_grade11"])) {  
        ...
        $content .= '  
            ...
            <h3>List of Grade 11 Students</h3>
        ...
        $content .= fetch_data_grade11();  
        $content .= '</table>';  
        $obj_pdf->writeHTML($content);  
        $obj_pdf->Output('report_inactive.pdf', 'D');  
     } 

    function fetch_data_grade12() {  
        include'include/config.php';
        $output = ''; 					
        $mysql_connection_object = mysqli_connect($servername,$username,$password,$dbname);
    ...
    if(isset($_POST["generate_pdf_grade12"])) {  
        require_once('tcpdf/tcpdf.php');
        $sql = "SELECT * FROM tbl_settings";
        $result = mysqli_query($mysql_connection_object, $sql);
        $set_data = mysqli_fetch_assoc($result);
        ...
        $content .= '  
            ...
            <p1>___________________________________________________________________________________________</p1>
            <h3>List of Grade 12 Students</h3>
            <table class="table table-hover" border="1" cellspacing="0" cellpadding="1" style="text-align: center;">
                <tr>  
                    <th width="4%">NO.</th>  
                    <th width="14%">LRN</th>  
                ...
                <div class="right_col" role="main" style="background-image: url(images/<?php echo $set_data['bg_image'];?>); background-repeat: no-repeat; background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Grade 11 <small></small></h2>
                                    <ul class="nav navbar-right panel_toolbox hidden-print">
                                        <li>
                                            <form method="post">
                                                <button type="submit" class="btn btn-sm btn-danger" name="generate_pdf_grade11"><i class='fa fa-file-pdf-o'> PDF</i></button>
                                            </form>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <form method="post">
                                        <h2>Grade 12 <small></small></h2>
                                        <ul class="nav navbar-right panel_toolbox hidden-print">
                                            <li>
                                                 <button type="submit" class="btn btn-sm btn-danger" name="generate_pdf_grade12"><i class='fa fa-file-pdf-o'> PDF</i></button>
                                            </li>
                                            <li><button class="btn btn-sm btn-dark" onclick="window.print()"><i class='fa fa-print'> Print</i></button></li>
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                            <li class="dropdown">
