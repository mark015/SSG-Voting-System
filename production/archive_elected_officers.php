        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main" style="background-image: url(images/<?php echo $set_data['bg_image'];?>); background-repeat: no-repeat; background-size: cover;">
                    ...
                    <form action="archive_candidates.php" method="get" role="form">
                    ...
                    <div class="hidden_div" style="text-align: center">
                        <h3><strong><?php echo $yr. " "; ?></strong>Elected Officers</h3>
                    </div>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><strong><?php echo $yr. " "; ?></strong>Elected Officers</h2>
