        ...
        <div id="sidebar-menu" class="main_menu_side main_menu hidden-print">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a><i class="fa fa-print"></i> Print Attendance <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="attendance_sheet1.php"> Grade 11 </a></li>
                            <li><a href="attendance_sheet2.php"> Grade 12 </a></li>
                        </ul>
                    </li>
                </ul>
            </div>
