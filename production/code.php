                            ...
                            <div class="x_content">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        <thead>
                                            <tr class="headings">
                                                <th class="column-title" style="width: 10px;">No.</th>
                                                <th class="column-title">LRN No.</th>
                                                <th class="column-title">Name</th>
                                                <th class="column-title">Access Code</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $sql="SELECT * FROM tbl_students WHERE level='Grade 11' ORDER BY lastname";
                            ...
                            <div class="x_content">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql="SELECT * FROM tbl_students WHERE level='Grade 12' ORDER BY lastname";
                                                $mysql_connection_object = mysqli_connect($servername,$username,$password,$dbname);
                                                $qry=$mysql_connection_object->prepare($sql);
                                                $qry->execute();
                                                $qry->bind_result($lrn_no, $track_id, $strand_id, $lastname, $firstname, $middlename, $ext_name, $gender, $bdate, $street, $barangay, $city, $province, $postal_code, $country, $mother, $father, $guardian, $telephone, $cellphone, $email, $level, $pass, $status);
